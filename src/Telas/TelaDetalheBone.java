...
public class TelaDetalheBone {
	...
	public void inserirEditar(int op, DadosControl d, 
			ListagemView p, int pos) {

		opcao = op;
		posicao = pos;
		dados = d;

		if (op == 1) s = "Cadastro de Boné Casual";
		if (op == 2) s = "Cadastro de Boné Esportivo";
		if (op == 3) s = "Detalhe de Boné Casual";
		if (op == 4) s = "Detalhe de Boné Esportivo";
		...
		labelTipo.setBounds(30, 110, 150, 25);
		valorTipo.setBounds(180, 110, 180, 25);
		labelCodigo.setBounds(30, 140, 150, 25);
		valorCodigo.setBounds(180, 140, 28, 25);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(src == botaoSalvar) {
			try {
				...
				novoDado[6] =  valorDescricao.getText();
